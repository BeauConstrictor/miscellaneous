...
# UI
UI_PADDING = 20            # How far from the edge of the screen to place ui
...
COLLISION_DETECT_GAP = 3 # Higher = better FPS, but less reliable collisions

# Gameplay
ORB_ATTRACTION_DIST = 50    # How close you need to be to an orb to eat it 
SPAWN_RADIUS = 3000         # How far away from origin to spawn bots and player
...
STARTING_LENGTH = (20, 300) # Starting length of player (left), and min-max for bots
...
ALLOW_DEBUG_CHEATS = True       # Enable special keys and open debug menu on startup
